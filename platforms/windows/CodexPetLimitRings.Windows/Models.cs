...
public sealed class OverlaySettings
{
    ...
    public bool NativeNotificationsEnabled { get; set; } = true;
    ...
    DateTimeOffset ReadAt)
{
    ...
    public double? PrimaryRemaining => PrimaryUsed is null ? null : Math.Clamp(100 - PrimaryUsed.Value, 0, 100);
    public double? SecondaryRemaining => SecondaryUsed is null ? null : Math.Clamp(100 - SecondaryUsed.Value, 0, 100);
}
